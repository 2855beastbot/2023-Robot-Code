...
private final Joystick joystickLeft = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Tank Drive: joystick", new TankDrive(() -> getJoystickLeft().getY(), () -> getJoystickRight().getY(), m_drivetrain));
    ...
    m_drivetrain.setDefaultCommand(new TankDrive(() -> getJoystickLeft().getY(), () -> getJoystickRight().getY(), m_drivetrain));
