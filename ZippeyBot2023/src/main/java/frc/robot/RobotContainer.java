...
private final Joystick joystickLeft = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    m_chooser.addOption("1: Face Back, Kicks, Reverses", new Up(m_arm).withTimeout(1).andThen( new Autodrive(6, 0.5, m_drivetrain)));
    m_chooser.setDefaultOption("2: Score Cube Drive Forewards", new Autodrive(0.5, 0.6, m_drivetrain).andThen( new Autodrive(6, -0.5, m_drivetrain)));
    m_chooser.addOption("3: Score and Balance", new ScoreBalance(m_drivetrain));
