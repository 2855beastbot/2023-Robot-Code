...
private final Joystick left = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("armUp", new armUp( m_arm ));
    SmartDashboard.putData("armDown", new armDown( m_arm ));
...
final JoystickButton downButton = new JoystickButton(right, 3);        
downButton.whileTrue(new armDown( m_arm ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton upButton = new JoystickButton(right, 5);        
upButton.whileTrue(new armUp( m_arm ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
